...
SMODS.Booster{
    ...
    loc_vars = function(self, info_queue, card)
        ...
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_zilliax
...
SMODS.Joker{
    ...
    loc_vars = function(self, info_queue, card)
        ...
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_haywire_module
        end
        if card.ability.zilmodule2 == true then
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_perfect_module
        end
        if card.ability.zilmodule3 == true then
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_power_module
        end
        if card.ability.zilmodule4 == true then
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_pylon_module
        end
        if card.ability.zilmodule5 == true then
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_recursive_module
        end
        if card.ability.zilmodule6 == true then
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_ticking_module
        end
        if card.ability.zilmodule7 == true then
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_virus_module
        end
        if card.ability.zilmodule8 == true then
        info_queue[#info_queue+1] = G.P_CENTERS.j_zil_twin_module
        end
        return { vars = {} }
    end,
